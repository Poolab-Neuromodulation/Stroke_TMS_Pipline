...
# 注：我这里偷懒了没有配准，直接拷贝了ants0GenericAffine.mat，正式pipeline中需要配准
MRTRIX3_SHARE='/home/guoxl/miniconda3/share/mrtrix3'
VISTASOFT_HOME=''
RAW_DWI='./DTI.nii.gz'
FIELDMAP=$2
AP_BVEC=$3
...
# tckgen -algo iFOD2 -act 5tt_nocoreg.mif -cutoff 0.05 -angle 35 -nthreads 4 -minlength 20 -maxlength 250 -crop_at_gmwmi -seed_image native_cst_R1.nii.gz -include $L_active_precentral_R  -stop wmcsd.mif L_active_CST_R_1e-3.tck -force
...
tckgen -algo iFOD2 -act 5tt_nocoreg.mif -cutoff 0.05 -angle 35 -nthreads 8 -minlength 20 -maxlength 250 -crop_at_gmwmi -seed_image  native_cst_R1.nii.gz -include $R_active_precentral_R  -stop wmcsd.mif R_active_CST_R_1e-3.tck -force

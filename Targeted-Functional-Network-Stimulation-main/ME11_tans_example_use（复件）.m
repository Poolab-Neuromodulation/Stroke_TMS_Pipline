...
setenv('LD_LIBRARY_PATH', sprintf('/home/guoxl/SimNIBS-4.0/simnibs_env/lib/python3.9/site-packages/simnibs/external/lib/linux:%s', getenv('LD_LIBRARY_PATH')))

% define some paths
Paths{1} = '/home/poolab/SimNIBS-4.0';
...
DataDir = '/home/poo'; % note: should be obvious, but user needs to manually define this
...
%     % isolate the target network
%     TargetNetwork = FunctionalNetworks;
%     TargetNetwork.data(TargetNetwork.data~=51) = 0; % note: 14 == left motor hand map.
%     TargetNetwork.data(TargetNetwork.data==51) = 1; % binarize.

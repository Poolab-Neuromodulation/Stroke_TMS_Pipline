...
MEDIR="/home/guoxl/fmridata/wyStroke/Liston-Laboratory-MultiEchofMRI-Pipeline-master/MultiEchofMRI-Pipeline"
...
EnvironmentScript="/usr/local/HCPpipelines/Examples/Scripts/SetUpHCPPipeline_gxl.sh" # Pipeline environment script

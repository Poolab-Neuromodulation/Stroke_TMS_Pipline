...
%system(['flirt -interp trilinear -in ' tmp_dir '/Label' num2str(i) '.nii.gz -ref ' AtlasTemplate ' -applyxfm -init /home/guoxl/fmridata/wyStroke/Liston-Laboratory-MultiEchofMRI-Pipeline-master/MultiEchofMRI-Pipeline/res0urces/ident.mat -out ' tmp_dir '/Label' num2str(i) '_Interp.nii.gz']);
system(['flirt -interp trilinear -in ' tmp_dir '/Label' num2str(i) '.nii.gz -ref ' AtlasTemplate ' -applyxfm -init /home/cputest/Stroke/Code/MultiEchofMRI-Pipeline/res0urces/ident.mat -out ' tmp_dir '/Label' num2str(i) '_Interp.nii.gz']);
